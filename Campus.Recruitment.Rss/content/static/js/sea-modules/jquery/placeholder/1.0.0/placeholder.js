        ...
        (function ($) {
            ...
            $.fn.placeholder = function (options) {
                return this.each(function () {
                    ...
                    var box_style = ['marginTop', 'marginLeft', 'paddingTop', 'paddingLeft', 'paddingRight', 'lineHeight'] //增加行高，以适应不同的input行高
                    ...
                    var position = function () {
                        ...
                        var borderW = parseInt($input.css('borderTopWidth'));
                        
                        if (!opt.hideOnFocus) {
                            // 按鍵隱藏的情况，需要移動光標两像素，@rex:depend on fontSize
                            pos.left += 2;
                        }
                        //如果input有border，对label的位置top 进行补偿
            ...
            //$(function () {
            //    var $input = $('input[placeholder]:visible');
