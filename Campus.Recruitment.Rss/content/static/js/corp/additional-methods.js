...
$(function () {
    ...
    /*check用户名 （6-20个英文字母、数字或下划线，不区分大小写）*/
    jQuery.validator.addMethod("truename", function (value, element) {
        var reg = /^[_0-9a-zA-Z]{6,20}$/;
        return this.optional(element) || reg.test($.trim(value));
    }, "6-20个英文字母、数字或下划线，不区分大小写");
    /*check密码 （6-20个英文字母、数字或字符，区分大小写）*/
    jQuery.validator.addMethod("checkpwd", function (value, element) {
        var reg = /^[A-Za-z0-9_][\x21-\x7e]{5,19}$/;
        return this.optional(element) || reg.test(value);
    }, "6-20个英文字母、数字或字符，区分大小写");

    jQuery.validator.addMethod("checkEtpName", function (value, element) {
        var reg = /^[a-zA-Z0-9\u4e00-\u9fa5(（)）\s]+$/;
        return this.optional(element) || reg.test($.trim(value));
    }, "请输入有效的公司简称");

    jQuery.validator.addMethod("checkEmail", function (value, element) {
        var reg = /^([a-zA-Z0-9]+[_|\-|\.]?)*[a-zA-Z0-9]+@([a-zA-Z0-9]+[_|\-|\.]?)*[a-zA-Z0-9]+\.[a-zA-Z0-9]{2,5}$/;
        return this.optional(element) || reg.test(value);
    }, '请输入正确的邮箱');
         
    jQuery.validator.addMethod("checkContactName", function (value, element) {
        var reg = /^([A-Za-z]|[\u4E00-\u9FA5])+$/;
        return this.optional(element) || reg.test($.trim(value));   
    }, "请输入有效的联系人");

    jQuery.validator.addMethod("checkAreaCode", function (value, element) {
        var reg = /^0\d{2,3}/;
        return this.optional(element) || reg.test($.trim(value));
    }, "请输入有效的区号");
    ...
    jQuery.validator.addMethod("checkCfmPassword", function (value, element) {
        var npwd = $('#NewPwd').val();
        return this.optional(element) || (npwd == value);
    }, "两次输入密码不一致");
