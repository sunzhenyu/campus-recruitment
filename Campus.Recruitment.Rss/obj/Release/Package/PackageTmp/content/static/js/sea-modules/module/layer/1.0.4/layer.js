define('module/layer/1.0.4/layer', function (require, exports, module) {
    var $ = require("$");
    (function (window, $, undefined) {
        ...
        var Layer = function (option) {
            this.config = {
                ...
                tplHtml: '<div class="ui-layer">' +
                            '<div class="ui-layer-container" data-role="container">' +
                                '<div class="ui-layer-header" data-role="header" id="hide-head">' +
            ...
            this._container = this.wrap.find('[data-role=container]').css({
                width: this.options.width,
                height: this.options.height
            })
            this._content = this.wrap.find('[data-role=content]');
        ...
        Layer.prototype = {
            ...
            bindEvent: function () {
                ...
                //this.move(this._header);          暂时关闭拖动事件
            ...
            move: function (movedom) {
                ...
                $(document).mousemove(function (e) {
                    ...
                    if (conf.ismove) {
                        ...
                        offsetY = mouseY - conf.moveY;              //容器到窗口顶部的距离
                        ...
                        console.log(Math.max(0, offsetY));
                        console.log(maxY);
                        console.log(Math.min(maxY, Math.max(0, offsetY)));
